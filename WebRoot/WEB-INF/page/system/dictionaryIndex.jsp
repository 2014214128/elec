	...
	function changetype() {
		...
		if (document.Form1.keyWord.value == "jerrynew") {
			...
			Pub.submitActionWithForm("Form2",
					"system/elecSystemDDLAction_edit.do", "Form1");
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left" width="30%"><s:select
							list="#request.systemList" id="keyWord" name="keyWord"
							listKey="keyWord" listValue="keyWord" headerKey="jerrynew"
							headerValue="" cssStyle="width:180px" cssClass="bg"
							onchange="changetype()">
						</s:select></td>
