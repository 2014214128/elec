		...
		<table cellSpacing="1" cellPadding="5" width="580" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><s:textfield
						name="loginName" id="loginName" maxlength="25" size="20"
						onblur="checkLoginName()"></s:textfield></td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input name="loginPassword"
					id="loginPassword" type="password" maxlength="25" size=22>
				</td>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input name="onDutyDate"
					type="text" maxlength="50" size="20"
					onclick="JavaScript:calendar(document.Form1.onDutyDate)"></td>
