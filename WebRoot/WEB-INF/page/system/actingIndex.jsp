...
<body>
	<s:form name="Form1" id="Form1" method="post">
		...
		<table id="opperate1" cellspacing="1" cellpadding="5" width="90%"
			align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3"
			border="0">
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
					<s:textarea name="stationRun" id="stationRun"
						cssStyle="width: 1000px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt"
			...
			<tr>
				<td class="ta_01" style="width: 100%" align="center"
					...
					style="font-size:12px; color:black; height=20;width=50"></td>
			</tr>
		</table>
	...
	<s:form name="Form2" id="Form2" method="post">
		<table id="opperate2" cellSpacing="1" cellPadding="0" width="90%"
			align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10>
					<td></td>
				</TR>
								...
								<s:iterator value="%{#request.commonList}" var="common">
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										<td style="HEIGHT:22px" align="center" width="40%"><s:property
												value="%{#common.stationRun}" /></td>
										<td style="HEIGHT:22px" align="center" width="40%"><s:property
												value="%{#common.devRun}" /></td>
										<td style="HEIGHT:22px" align="center" width="20%"><s:property
												value="%{#common.createDate}" /></td>
									</tr>
								</s:iterator>
							</s:if>
						</table>
