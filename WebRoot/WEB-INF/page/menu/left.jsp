...
<%
String popedom = (String)request.getSession().getAttribute("global_popedom"); 
Hashtable ht = (Hashtable)request.getSession().getAttribute("global_role");
%>
<HTML>
	<HEAD>
		<TITLE>Left</TITLE>
						...
						<DIV class="child" id="KB4Child">
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=${global_user.userID }&roleflag=1" target="mainFrame">用户管理</A>
										</TD>
									</TR>
