...
public class ElecCommonMsgServiceImpl implements IElecCommonMsgService {
	...
	public List<ElecCommonMsgForm> findElecCommonMsgList() {
		...
		List<ElecCommonMsgForm> formList = this
				.elecCommonMsgPOListTOList(elecCommonMsgDAO
	...
	public List<ElecCommonMsgForm> findElecCommonMsgListByCurrentDate() {
		...
		List<Object[]> list = elecCommonMsgDAO
				.findElecCommonMsgListByCurrentDate(currentDate);
		List<ElecCommonMsgForm> formList = this
				.elecCommonMsgObjectListToVOList(list);
		return formList;
	}
